        ...
        <ul>
          <li class="rating-item" v-for="(rating, index) in filterRatings" :key="index">
            ...
            <div class="content">
              ...
              <div class="recommend">
                <span class="iconfont" :class="rating.rateType === 0 ? 'icon-zan' : 'icon-tucao-tianchong'"></span>
  ...
  export default {
    ...
    created () {
        this.$ajax({
            ...
            this.$store.commit('receive_ratings', res.data.data)
            this.$nextTick(() => {
      ...
      .rating-item
        ...
        .content
          ...
          .recommend
            line-height: 16px
            font-size: 0
            .icon-zan, .icon-tucao-tianchong, .item
              display: inline-block
              margin: 0 8px 4px 0
              font-size: 9px
            .icon-zan
