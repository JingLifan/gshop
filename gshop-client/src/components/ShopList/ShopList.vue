    ...
    <div class="shop_container">
        <ul class="shop_list" v-if="shops.length">
            <li class="shop_li border-1px" v-for="(shop, index) in shops" :key="index"  @click="$router.push('/shop')">
                <a>
                    <div class="shop_left">
                        <img class="shop_img" src="http://localhost:4000/user/images/1.jpg">
                    </div>
                    <div class="shop_right">
                        ...
                        <section class="shop_rating_order">
                            ...
                            <span class="delivery_style delivery_right">同城专送</span>
                            </section>
                        </section>
        ...
        <ul class="shop_list" v-else>
            <li class="shop_li border-1px" v-for="item in 5" :key="item">
                <img src="./images/shop_back.svg" alt="" srcset="">
            </li>
        </ul>
    </div>
</template>
